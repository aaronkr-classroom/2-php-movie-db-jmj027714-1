...
<div data-role="page" id="page3">
    ...
    <div data-role="content">
        <h3>영화 내용 삭제</h3>
        <form name="form1" method="post" action="delete_result.php" data-ajax="false">
            <div class="ui-body ui-body-a">
                <label for="movieGenre3">장르:</label>
                ...
                <label for="movieYear3">상영년도:</label>
